...
>
> **可立即开始的范围**：无障碍 a11y、主题/token、性能、流程/状态 四组。
> **暂停**：设计语言组（待产品讨论，见 ⏸️ 标记）。
> **已结案不再追**：产品逻辑（亲子保留在旅行偏好；节奏关键词、notes 优先级后端已处理）。
...
### ⏸️ 设计语言 / 反 slop（taste-skill）—— 暂停，待讨论后再开始
> 这组涉及审美取舍，会改变现有认可的视觉，需产品在场拍板。新窗口/自动化**先勿动**。
